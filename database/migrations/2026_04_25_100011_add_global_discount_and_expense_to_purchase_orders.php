...
return new class extends Migration {
    public function up(): void
    {
        Schema::table('purchase_orders', function (Blueprint $table) {
            ...
            $table->decimal('expense_capitalized_total', 18, 2)->default(0)->after('global_discount_amount');
            $table->decimal('expense_direct_total', 18, 2)->default(0)->after('expense_capitalized_total');
        });
    }

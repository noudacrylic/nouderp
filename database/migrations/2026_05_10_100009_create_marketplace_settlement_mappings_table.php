...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('marketplace_settlement_mappings', function (Blueprint $table) {
            ...
            // Header row index (0-based) di Excel — biasanya 0 untuk Tokopedia, kadang 4 untuk Shopee
            $table->unsignedTinyInteger('header_row_index')->default(0);
            // Nama kolom Excel yg dipetakan ke field
            ...
            // Optional: kolom tambahan yg dijumlahkan ke admin_fee (mis. "Biaya Layanan", "Biaya Asuransi")

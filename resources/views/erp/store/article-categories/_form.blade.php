...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <div>
        ...
        <input type="text" name="name" value="{{ old('name', $category->name ?? '') }}" required
               class="border rounded px-2 py-1.5 w-full" placeholder="mis. Tips & Panduan">
    </div>
    <div>
        ...
        <p class="text-xs text-gray-400 mt-1">Dipakai di URL: /blog/kategori/<i>slug</i></p>
    </div>
    <div>
...
<div class="flex gap-2 mt-5">
    ...
    <a href="{{ route('store.article-categories.index') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded text-sm">Batal</a>
</div>

...
<div class="flex items-center justify-between mb-4">
    ...
    <div class="flex gap-2">
        <a href="{{ route('pos.fulfillment.perlu-diproses') }}" class="bg-purple-600 hover:bg-purple-700 text-white px-3 py-2 rounded text-sm" title="Kembali ke Pemrosesan Pesanan (POS)">← Pemrosesan Pesanan</a>
                    ...
                    <td class="px-3 py-2 text-right" onclick="event.stopPropagation()">
                        <div class="flex gap-1 flex-row-reverse flex-wrap">
                            ...
                            @if($isDraft)
                                ...
                                {{-- Draft belum menahan stok. Kirim link bayar dulu; SO di-post
                                     otomatis begitu DP masuk (CustomerPaymentService::post). --}}
                                <button type="button"
                                        data-so-id="{{ $so->id }}"
                                        ...
                                        class="bg-purple-600 text-white px-2 py-1 rounded text-xs inline-flex items-center gap-1"
                                        title="Kirim tautan pembayaran — stok belum ditahan sampai dibayar">
                                    DP

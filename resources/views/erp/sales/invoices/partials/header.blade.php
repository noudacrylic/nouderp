<h4>Faktur {{ $invoice->invoice_number }}</h4>
...
<div class="flex items-center gap-6 text-sm">
    ...
    <div>
        ...
        @if($invoice->status === \App\Enums\InvoiceStatusEnum::DRAFT)
            <span class="px-2 py-0.5 rounded text-[10px] font-bold uppercase bg-gray-100 text-gray-400 border border-gray-200">DRAF</span>
...
<span class="ms-3">Pelanggan : {{ $invoice->customer->name ?? '-' }}</span>

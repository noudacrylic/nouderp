...
<div class="flex items-center justify-between mb-4">
    <h1 class="text-lg font-semibold">Import Faktur Masal &mdash; Shopee Order Export</h1>
...
@if(session('import_successes') && count(session('import_successes')) > 0)
    <div class="bg-green-50 border border-green-200 rounded p-3 mb-3 text-sm">
        <div class="font-semibold text-green-800 mb-1">Faktur berhasil dibuat &amp; dipost:</div>
...
<div class="bg-white rounded shadow p-4 max-w-2xl">
    ...
    <div class="mt-6 text-sm text-gray-700">
        ...
        <ul class="list-disc pl-5 space-y-1">
            ...
            <li>Pesanan yang gagal di-skip; pesanan lain tetap diproses. Rincian muncul setelah import.</li>
        </ul>
    </div>
</div>
@endsection

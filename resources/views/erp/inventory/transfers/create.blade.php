                ...
                <div>
                    ...
                    <select name="from_warehouse_id" id="from_warehouse_id"
                        ...
                        @foreach($warehouses as $wh)
                            <option value="{{$wh->id}}" {{ $fromWhSelected == $wh->id ? 'selected' : '' }}>
                                {{$wh->name}}
                            </option>
                        @endforeach
                    </select>
                ...
                <table class="w-full border rounded overflow-hidden" id="items-table">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <tr class="item-row">
                            ...
                            <td class="p-3 text-gray-600 font-mono sku"></td>
                            <td class="p-3 text-green-600 font-bold stock">0</td>
                            <td class="p-3">
                                <input type="number" name="qty[]" step="0.0001"
    ...
    <script>
        ...
        document.addEventListener('change', async function (e) {
            ...
            if (e.target.id === 'from_warehouse_id') {
                // Update all items stock if warehouse changes

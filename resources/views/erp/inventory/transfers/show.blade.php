...
@section('content')
    ...
    <div class="max-w-4xl mx-auto py-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">Transfer Stock Details</h1>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden mb-6">
            <div class="p-6 border-b border-gray-50 bg-gray-50/50">
                <div class="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm">
                    <div>
                        <span class="text-gray-500 block mb-1">Transfer Number</span>
                    ...
                    <div>
                        <span class="text-gray-500 block mb-1">From Warehouse</span>
                        <span class="font-bold text-gray-800 text-red-600">{{ $transfer->fromWarehouse->name ?? '-' }}</span>
                    </div>
                    <div>
                        <span class="text-gray-500 block mb-1">To Warehouse</span>
                ...
                <div class="mt-4">
                    ...
                    @if ($transfer->status == 'draft')
                        <span class="px-3 py-1 text-xs font-bold uppercase bg-gray-100 text-gray-500 rounded-full">Draft</span>
                    @elseif($transfer->status == 'posted')
                        <span class="px-3 py-1 text-xs font-bold uppercase bg-green-100 text-green-700 rounded-full">Posted</span>

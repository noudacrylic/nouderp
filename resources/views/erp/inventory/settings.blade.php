        ...
        <div class="bg-white shadow rounded-lg border p-6">
            ...
            <form method="POST" action="{{ route('settings.inventory.update') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <!-- Asset Account -->
                    <div class="space-y-2">
                        <label class="block text-sm font-bold text-gray-600 uppercase tracking-wider">Akun Aset
                            Persediaan</label>
                        ...
                        <p class="text-xs text-gray-400">Akun default untuk penilaian stok.</p>
                    </div>

                    <!-- Gain Account -->
                    <div class="space-y-2">
                        <label class="block text-sm font-bold text-gray-600 uppercase tracking-wider">Akun Selisih Lebih
                            Stok</label>
                        ...
                        <p class="text-xs text-gray-400">Akun untuk penyesuaian stok positif.</p>
                    </div>

                    <!-- Loss Account -->
                    <div class="space-y-2">
                        <label class="block text-sm font-bold text-gray-600 uppercase tracking-wider">Akun Selisih Kurang
                            Stok</label>
                        ...
                        <p class="text-xs text-gray-400">Akun untuk penyesuaian stok negatif.</p>
                    </div>

                    <!-- Repair Account -->
                    <div class="space-y-2">
                        <label class="block text-sm font-bold text-gray-600 uppercase tracking-wider">Akun Perbaikan Stok Rusak</label>
                        ...
                        <p class="text-xs text-gray-400">Akun yang didebit untuk penyesuaian perbaikan stok rusak (mis. Persediaan Perbaikan).</p>
                    </div>

                    <!-- OB Account -->
                    <div class="space-y-2">
                        <label class="block text-sm font-bold text-gray-600 uppercase tracking-wider">Akun Saldo Awal</label>
                        ...
                        <p class="text-xs text-gray-400">Akun untuk stok awal (mis. Ekuitas/Modal Awal).</p>
                    </div>
